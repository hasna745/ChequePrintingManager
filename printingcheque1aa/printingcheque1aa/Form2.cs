...
namespace printingcheque1aa
{
    public partial class Form2 : Form
    {
        ...
        public string Last20Digits
        {
            get { return TbNumeroCheque.Text; }
            set { TbNumeroCheque.Text = value; }
        }
        ...
        private void Form2_Load_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM chequeprint.information_cheque_client where cin=@cin ;";
        ...
        private void TbNumeroCheque_TextChanged(object sender, EventArgs e)
        {
